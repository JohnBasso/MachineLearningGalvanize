Galvanize - Introduction to Machine Learning

Date: 2017-10-14

Week 1 - Day 2 - Homework Assignments

10 Different functions to complete a variety of tasks to test our understanding of Python logic
...
9.  One can use loops to compute the elements of a mathematical series. Series can be defined recursively with the value of each element depending on the one that comes before it. Consider the series created by the rules:
    ...
    a<sub>0</sub> = 1 and a<sub>i + 1</sub> = 2 * a<sub>i</sub> + 1 for <sub>i</sub> > 0
